...
class TVShowProbe(Probe):
    ...
    def search_seasons(self, tv_show: dict) -> None:
        ...
        for imdb_season_number in imdb_show['episodes']:
            ...
            # Update with new episodes being added
    ...
    def download_season(self, season: dict) -> None:
        ...
        Note: A show is never downloaded as a whole (Future Feature)

        Args:
            season (dict): the tv show season
        """
    ...
    def download(self, name: str,
        ...
        Args:
            ...
            max_season_size_mb (int): _description_
            resolution_profile (set): _description_
            episode_number (int, optional): _description_. Defaults to None.
    ...
    def update(self) -> None:
        ...
        for season in seasons:
            ...
            # If there's not season hash, it means that the episodes were downloaded individually
            if not season_hash:
